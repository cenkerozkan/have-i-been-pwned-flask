...
class Scheduler:
    ...
    def _register_pwn_check_job(self) -> None:
        ...
        interval_unit: str = self._config_repo.get_value("pwn_check_interval_unit", "hours")
        interval_value: int = int(self._config_repo.get_value("pwn_check_interval_value", "1"))
        ...
        self._logger.info(f"Scheduled pwn check job to run every {interval_value} {interval_unit}")
