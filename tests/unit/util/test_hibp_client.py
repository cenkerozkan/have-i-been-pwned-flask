...
class TestHibpClient:
    ...
    @patch('requests.get')
    def test_get_breached_accounts_success(self, mock_get, hibp_client, mock_env_with_key, sample_breach_response):
        ...
        assert "https://haveibeenpwned.com/api/v3/breachedaccount/test@example.com" in args[0]
    ...
    @patch('requests.get')
    def test_get_breached_accounts_truncate_param(self, mock_get, hibp_client, mock_env_with_key):
    ...
    @patch('requests.get')
    def test_get_breached_accounts_no_breaches(self, mock_get, hibp_client, mock_env_with_key):
    ...
    @patch('requests.get')
    def test_get_breached_accounts_unauthorized(self, mock_get, hibp_client, mock_env_with_key):
    ...
    @patch('requests.get')
    def test_get_breached_accounts_unexpected_status(self, mock_get, hibp_client, mock_env_with_key):
    ...
    @patch('requests.get')
    def test_get_breached_accounts_request_exception(self, mock_get, hibp_client, mock_env_with_key):
    ...
    @patch('requests.get')
    def test_get_breached_accounts_multiple_breaches(self, mock_get, hibp_client, mock_env_with_key):
